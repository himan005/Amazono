      ...
      if(product.price){
        if(product.categoryId){
          if(product.description){
            ...
            this.data.error('Please enter the description of product');
          }
        }else{
          this.data.error('Please select category for product');
        }
      }else{
        this.data.error('Please enter price of product.');
      }
    } else{
      this.data.error("Please enter title of product.");
    }
  }
